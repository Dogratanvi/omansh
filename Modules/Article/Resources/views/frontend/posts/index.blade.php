    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <x-frontend.card :url="$details_url" :name="$$module_name_singular->name"
            ...
            <div class="flex flex-row items-center my-4">
                <img class="w-5 h-5 sm:w-8 sm:h-8 rounded-full" src="{{asset('img/avatars/'.rand(1, 8).'.jpg')}}"
            ...
            <p>
                ...
                <x-frontend.badge :url="route('frontend.tags.show', [encode_id($tag->id), $tag->slug])"
                    :text="$tag->name" />
                @endforeach
            </p>
        </x-frontend.card>
