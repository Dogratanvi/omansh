                    ...
                    <div class="row" data-aos="fade-up">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box box_padding d-flex align-items-center">
                                <div class="box_image_content">
                                    <figure class="mb-0">
                                        <img src="{{ asset('images/contact_location.png') }}" alt=""
                                            class="img-fluid">
                                    </figure>
                                </div>
                                <div class="box_wrapper">
                                    <h3>Location</h3>
                                    <p class="mb-0">Plot No-290, in front of ramprastha green gate No.1, sector-4,
                                        vaishali,
                                        ghaziabad, 201 019</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box d-flex align-items-center">
                                <div class="box_image_content">
                                    <figure class="mb-0">
                                        <img src="{{ asset('images/contact_phone.png ') }}" alt=""
                                            class="img-fluid">
                                    </figure>
                                </div>
                                <div class="box_wrapper">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="box mb-0 d-flex align-items-center">
                                <div class="box_image_content">
                                    <figure class="mb-0">
                                        <img src="{{ asset('images/contact_mail.png') }}" alt=""
                                            class="img-fluid">
                                    </figure>
                                </div>
                                <div class="box_wrapper">
