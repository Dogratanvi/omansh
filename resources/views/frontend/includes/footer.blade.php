...
<section class="footer-section" id="footer_section">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 d-sm-block ">
                    <div
                        ...
                        <ul
                            ...
                            <li class="mb-0 about-addrsss d-flex ">
                                <i class="fa-solid fa-location-dot location pt-1"></i>
                                <span>
    ...
    <a href="https://wa.me/+91 85270 45759" target="_blank" class="whtsapp"><svg width="60" height="60"
