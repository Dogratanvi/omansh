                ...
                <div class="row pt-sm-0 pt-lg-5 pt-0 pt-xl-5 pt-md-5 pt-xs-0">
                    <div class="col-md-4 mt-4">
                        <div class="card health-card border-0">
                            <a href="/services/womenhealth/bladder-dysfunction"><img src="{{ asset('img/bladder.png') }}"
                                    class="w-100" alt="bladder"></a>
                            <div class="card-content">
                                ...
                                <div class="btn_wrapper ps-3">
                                    <a href="/services/womenhealth/bladder-dysfunction"
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="card health-card  border-0">
                            <a href="/services/womenhealth/bowel-issues-and-prolapse"> <img
                                class="w-100" src="{{ asset('img/services/Bowel_Issues.png') }}" alt="bowel"></a>
                                <div class="card-content">
                                    ...
                                    <div class="btn_wrapper ps-3">
                                        <a href="/services/womenhealth/bowel-issues-and-prolapse"
                                            class="item-link women-health-link">Read More <i
                                                class="fa fa-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="card health-card  border-0">
                            <a href="/services/womenhealth/pelvic-floor-dysfunctions"> <img
                                class="w-100" src="{{ asset('img/services/Pain_Dysfunctions.png') }}" alt="Pain Dysfunctions"></a>
                                <div class="card-content">
                                    ...
                                    <div class="btn_wrapper ps-3">
                                        <a href="/services/womenhealth/pelvic-floor-dysfunctions"
                                            class="item-link women-health-link">Read More <i
                                                class="fa fa-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="card health-card  border-0">
                            <a href="/services/womenhealth/pregnancy-and-postpartum"><img
                                class="w-100" src="{{ asset('img/services/Postpartum.png') }}" alt="Postpartum"></a>
                                <div class="card-content">
                                    ...
                                    <div class="btn_wrapper ps-3">
                                        <a href="/services/womenhealth/pregnancy-and-postpartum"
                                            class="item-link women-health-link">Read More <i
                                                class="fa fa-arrow-right"></i></a>
                    ...
                    <div class="col-md-4 mt-4">
                        <div class="card health-card  border-0">
                            <a href="/services/womenhealth/exercise-programs-and-pilates"><img
                                class="w-100" src="{{ asset('img/services/Excercise_Programs.png') }}" alt="Excercise Programs"></a>
                                <div class="card-content">
                                    <h4>Excercise Programs & Pilates</h4>
                                    <ul>
                                        <li>At World of Women, we offer Pilates Personalised Exercise Programs Prenatal &
                                            Postnatal
                                            Pilates Physio Led Pregnancy Class Mums and Bubs </li>
                                    </ul>
                                    <div class="btn_wrapper ps-3">
                                        <a href="/services/womenhealth/exercise-programs-and-pilates"
                                            class="item-link women-health-link">Read More <i
                                                class="fa fa-arrow-right"></i></a>
