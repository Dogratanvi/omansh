        ...
        <section class="banner-section">
            <div class="container">
                ...
                <figure class="banner_right_bottom_shape right_shape mb-0">
                    <img src="{{ asset('images/banner_right_bottom_shape.png') }}" alt="banner_right_bottom_shape right_shape" class="img-fluid">
                </figure>
            </div>
    </div>
    </section>
...
<p>
        ...
        <ol>
            <li><strong>Use of the Website</strong><br>a) Eligibility: You must be at least 13 years old to use our
                Website. If you are under the age of 18, you may use our Website only with the involvement and consent
            ...
            <li><strong>User Guidelines</strong><br>a) Prohibited Content: You must not post, transmit, or share any
                content that is unlawful, offensive, defamatory, or infringing on the rights of others. This includes
                content that promotes discrimination, violence, or illegal activities.<br>b) User Conduct: You agree not
                to engage in any activity that could disrupt or interfere with the functioning of our Website or
                compromise its security. This includes attempts to gain unauthorized access to our systems.</li><span
            ...
            <li><strong>Modifications and Termination</strong><br>YogaDura reserves the right to modify or terminate the
                Website or these Terms at any time without prior notice. We may also suspend or terminate your access to
                the Website if you violate these Terms or engage in any conduct that we deem inappropriate or harmful.
            </li>
            <li><strong>Governing Law and Jurisdiction</strong><br>These Terms shall be governed by and construed in
                accordance with the laws of Toronto. Any legal action or proceeding arising out of or relating to these
                Terms or the use of our Website shall be brought exclusively in the courts located in Toronto, ON.</li>
