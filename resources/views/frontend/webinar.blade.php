                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12 col-sm-12 col-xs-12">
                        <div class="image-sec p-3 p-sm-3 p-xs-3 p-md-3 p-xl-5 p-lg-3 p-xxl-5">
                            <h2 class="sub-heading-text text-white pt-0 pt-sm-0 pt-xs-0 pt-md-4 pt-xl-5 pt-lg-5"> Omansh Health & Fitness</h2>
                            <p class="health-des text-white">Discover essential tips to make your delivery smoother and
                                less stressful.</p>
                            <button class="webinar-btn shadow-none border-0 rounded text-white py-2 px-3 mb-3 mb-sm-3 mb-xs-3 mb-md-3 mb-lg-0 mb-xl-0 mt-4">SIGNUP
                                NOW ₹199</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="row d-flex justify-content-between">
                    <div class="col-md-5 text-center timer-box counters-text text-center text-white text-uppercase p-3 rounded">
    ...
    <div class="banner-sec-two">
        <div class="container">
            ...
            <div class="banner-text-two">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <h5 class="top-heading m-0 py-0 py-lg-4 py-xl-4 py-md-4 py-xs-4 py-sm-4 text-white text-center">Whether you are a first time mom or
            ...
            <div class="why-choose-us-sec">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h2 class="sub-heading  text-center mb-0 mb-xs-0 pt-0 pt-sm-0 pt-xs-0 pt-md-2 pt-xl-5 pt-lg-5 mb-sm-0 mb-md-3 mb-xl-4 mb-lg-4">Meet Our Expert</h2>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-0 mt-sm-0 mt-xs-0 mt-md-2 mt-xl-3 mt-lg-3">
                        <h2 class=" text-center pt-4 pt-sm-4 pt-xs-5 pt-md-4 pt-lg-5 pt-xl-5 sub-heading">Questions</h2>
                        <div class="omansh-listing">
                            <p class="health-des text-dark pt-0 pt-sm-0 pt-xs-0 pt-md-2 pt-lg-4 pt-xl-4 text-center">Still have any questions</p>
                            <ul class="list-group">
                                <li class="list-group-item border-0"> <svg width="25" height="38" viewBox="0 0 38 38"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
...
<script>
        function countdownTimerCustom() {
            ...
            const x = setInterval(function() {
                ...
                document.getElementById("minutes-custom").children[0].textContent = minutes < 10 ? '0' + minutes : minutes;
                document.getElementById("seconds-custom").children[0].textContent = seconds < 10 ? '0' + seconds : seconds;
