                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-4">
                        <div class="item">
                            <div class="review-card bg-white rounded ">
                                <div class="review-header">
                                    <img src="{{ asset('img/webinar/asees.png ') }}" alt="User Image"
                                        class="review-avatar">
                                    <div class="review-details">
                                        <h4>Asees Kaur</h4>
            ...
            <div class="container">
                ...
                <div class="banner-text-two">
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                            <h5
                                class="top-heading m-0 py-0 py-lg-4 py-xl-4 py-md-4 py-xs-4 py-sm-4 text-white text-center">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="omansh-listing pt-3">
                                ...
                                <div class="image-sec text-center pt-3">
                                    <img class="w-100 h-100" alt="expert"
                                        src="{{ asset('img/webinar/meet-expert.png ') }}">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mt-0 mt-sm-0 mt-xs-0 mt-md-2 mt-xl-3 mt-lg-3">
                            ...
                            <div class="omansh-listing">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item border-0"> <svg width="25" height="38"
                    ...
                    <div class="modal-body p-5">
                        <form id="signupForm">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="3" name="experience_pregnancy_complications" id="pregnancyComplications" class="form-control"
                                    required></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea rows="3" name="medical_conditions" id="specialMedicalConditions" class="form-control" required></textarea>
                            </div>
                                ...
                                <div class="checkbox-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="primary_goal"
                                            ...
                                            {{ old('current_trimester') == 'Other' ? 'checked' : '' }}>
                                ...
                                <div class="checkbox-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="hear_about_us"
                                            ...
                                            {{ old('current_trimester') == 'Website' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="hear_about_us"
                                            id="referral" value="Friend/Referral"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="hear_about_us"
                                            ...
                                            {{ old('current_trimester') == 'Doctor' ? 'checked' : '' }}>
