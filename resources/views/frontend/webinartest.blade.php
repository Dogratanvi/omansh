
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-center"><button
                            ...
                            this
                            webinar at just ₹499</button></div>
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <p class="date-sec text-center text-white p-3 rounded mb-3"> <svg width="40" height="40"
                                viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M20 3.33331C17.8113 3.33331 15.6441 3.76441 13.622 4.60399C11.5999 5.43957 9.76257 6.66722 8.21493 8.21487C5.08932 11.3405 3.33337 15.5797 3.33337 20C3.33337 24.4203 5.08932 28.6595 8.21493 31.7851C9.76257 33.3327 11.5999 34.5604 13.622 35.398C15.6441 36.2355 17.8113 36.6666 20 36.6666C24.4203 36.6666 28.6595 34.9107 31.7852 31.7851C34.9108 28.6595 36.6667 24.4203 36.6667 20C36.6667 17.8113 36.2356 15.644 35.398 13.6219C34.5605 11.5998 33.3328 9.76251 31.7852 8.21487C30.2375 6.66722 28.4002 5.43957 26.3781 4.60399C24.356 3.76441 22.1887 3.33331 20 3.33331ZM27 27L18.3334 21.6666V11.6666H20.8334V20.3333L28.3334 24.8333L27 27Z"
                                    fill="white" />
                            </svg> 12:30 pm </p>
                    </div>
                </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  pt-0 pt-sm-0  pt-xs-0 pt-md-3 pt-lg-5 pt-xl-5">
                ...
                <div class="omansh-listing pt-0 pt-sm-0  pt-xs-0 pt-md-3 pt-lg-5 pt-xl-5">
                    ...
                    <div class="whychoose-btn text-center">
                        <button
                            class="webinar-btn shadow-none border-0 rounded text-white py-2 px-3 mt-4 text-center">Sign up now at ₹499</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container my-5">
        ...
        <div class="text-center">
            <button class="webinar-btn shadow-none border-0 rounded text-white py-2 px-3 mt-5 text-center">Sign up now at ₹499</button>
        </div>
    </div>
   ...
   <div class="col-md-4 mt-3 mt-sm-3 mt-xs-3 mt-md-0 mt-xl-0 mt-lg-0">
    <a href="https://www.youtube.com/embed/wus_-JT68Kg?autoplay=1&mute=1" 
       data-toggle="lightbox"  
       data-type="iframe" 
       class="position-relative">
        <img src="{{ asset('img/webinar/secondimage.png') }}" class="img-fluid" alt="Webinar Thumbnail">
        <i class="fa-brands fa-youtube"></i>
    </a>
</div>
         <div class="col-md-4 mt-3 mt-sm-3 mt-xs-3 mt-md-0 mt-xl-0 mt-lg-0">
        ...
        <div class="container">
            <div class="webinar-sec">
                <div class="row">
                    ...
                    <div class="col-lg-12 mt-5 col-md-12 col-sm-12 col-xs-12">
                        <div class="omansh-listing">
                            <p class="webinar-des text-center">For Videos Related to Pregnancy</p>
                        </div>
                        <a href="https://www.youtube.com/@drgarimabiswas6613"  target="_blank" class="text-dark w-100 m-auto d-flex justify-content-center text-center fs-2 ">Subscribe to Our YouTube Channel</a>
                       <a href="https://www.youtube.com/@drgarimabiswas6613" target="_blank"> <img class="pt-4  d-flex justify-content-center m-auto" alt="expert" src="https://omansh.org/img/webinar/youtube.png"></a>
                    </div> 
                </div>
            </div>
        </div>
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Your payment was successful. Please join our Whatsapp group!</p>
            <p><a href="https://chat.whatsapp.com/EpHIB2kdtguBVBBBcOSa2O">Join the Group</a></p>
        </div>
        ...
        var formData = new FormData(this);
          ...
          var formData = new FormData(this);
                ...
                function validateForm() {
                    ...
                    var radioGroups = ['current_trimester', 'first_pregnancy','like_receive_updates'
                    ];
